...
export default function selectNowPlaying () {
    var requisição = axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=00677d2daa69a1cc4505e8c461dd2031');
